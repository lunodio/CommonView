...
public abstract class LOrientationHelper {
    ...
    private LOrientationHelper(RecyclerView.LayoutManager layoutManager) {
     ...
     */
    public static LOrientationHelper createOrientationHelper(
     ...
     * @return A new OrientationHelper
     */
    public static LOrientationHelper createHorizontalHelper(
            RecyclerView.LayoutManager layoutManager) {
        return new LOrientationHelper(layoutManager) {
            @Override
     ...
     * @return A new OrientationHelper
     */
    public static LOrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new LOrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
