 ...
 */
public class LConstraintLayout extends ConstraintLayout implements LMethodInterface {
    ...
    public LConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public LConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
